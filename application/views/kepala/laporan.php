 <table class="table table-sm" border="2" width="100%">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><center><?= $l->id_laporan ?></center></td>
      <td><center><?= $l->nama_laporan ?></center></td>
      <td><center><?=date('d-m-Y',strtotime($l->tgl_dibuat))?></center></td>
      <td><center><a href="<?php echo base_url().'kepala/download/'.$l->id_laporan; ?>" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-download-alt">Download</a></center></td>
        <?php
              }
              ?>
    </tr>
