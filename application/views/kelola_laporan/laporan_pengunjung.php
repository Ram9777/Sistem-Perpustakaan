...
<h1 class="h3 mb-4 text-gray-800"><?= $title; ?></h1>
    ...
    <tr class="bg-success" style="text-decoration-style: bold">
      <th scope="col"><center><b>No</b></center></th>
       <th scope="col"><center><b>Tanggal Datang</b></center></th>
       
       
      <th scope="col"><center><b>ID Anggota</b></center></th>
      <th scope="col"><center><b>Tujuan</b></center></th>
    ...
    if( ! empty($buku_tamu)){
        ...
        foreach($buku_tamu as $btu){
            ...
            echo "<td><center>".$btu->id_anggota."</center></td>";
            echo "<td><center>".$btu->tujuan."</center></td>";
            echo "<td><center>".$btu->nama."</center></td>";
